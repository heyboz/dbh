...
def cluster_size(dbh_unique, D, dbh_threshold, distance_threshold):
    ...
    plt.savefig('E:/Outputs/Cluster/dbh20_distance50/ClusterSize/' + figname1)
    plt.close()
    ...
    plt.savefig('E:/Outputs/Cluster/dbh20_distance50/DBH/' + sp+'_DBH'+'.png')
    plt.close()
    ...
    plt.savefig('E:/Outputs/Cluster/dbh20_distance50/Location/' + sp+'_Location'+'.png')
    plt.close()
    #return clusters
